...
import { ChevronRight, Home, Settings, Trophy, Users, MessageSquare, UserCheck, UserX, BarChart3 } from "lucide-react"
              ...
              >
                <CardContent className="p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-lg md:text-xl font-semibold text-green-800 mb-2">{option.title}</h3>
