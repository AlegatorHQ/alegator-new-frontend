        ...
        <main className="flex-1 p-8 overflow-auto">
          ...
          <div className="flex gap-4 mb-6">
            <Button
              ...
              className={activeTab === "teams" ? "bg-green-800 text-white" : "border-green-800 text-green-800"}
            >
            ...
            <Button
              ...
              className={activeTab === "judges" ? "bg-green-800 text-white" : "border-green-800 text-green-800"}
            >
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-xl font-semibold text-green-800">{team.name}</h3>
                          <Badge
                            variant={team.status === "confirmed" ? "default" : "secondary"}
                            className={team.status === "confirmed" ? "bg-green-600" : "bg-yellow-500"}
                          >
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" className="border-green-800 text-green-800 bg-transparent">
                          Editar
                        </Button>
                        <Button variant="outline" size="sm" className="border-red-500 text-red-500 bg-transparent">
                          Eliminar
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <Badge
                            variant={judge.status === "confirmed" ? "default" : "secondary"}
                            className={judge.status === "confirmed" ? "bg-green-600" : "bg-yellow-500"}
                          >
                            {judge.status === "confirmed" ? "Confirmado" : "Pendiente"}
                          </Badge>
                        </div>
                        <p className="text-gray-600 mb-2">
